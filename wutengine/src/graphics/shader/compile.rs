...
use super::{CompiledShader, Shader, ShaderParameter};
...
pub(crate) fn compile(shader: &Shader, keywords: &HashMap<String, u64>) -> Arc<CompiledShader> {
    ...
    let compile_output = wutengine_shadercompiler::compile::<ShaderId, XXHashShaderHasher>(Input {
        source_id: shader.id,
    ...
    super::cache::shader::insert(cache_key, compiled)
}
