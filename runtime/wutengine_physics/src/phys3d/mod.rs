...
struct PhysicsResultHandler {
    ...
    collisions: Receiver<rapier3d::geometry::CollisionEvent>,

    /// Contact force event receiver
    contact_force: Receiver<rapier3d::geometry::ContactForceEvent>,
}
...
impl PhysicsResultHandler {
    ...
    fn handle_collision_event(collision: rapier3d::geometry::CollisionEvent) {
        profiling::function_scope!();
    ...
    fn handle_contact_force_event(contact_force: rapier3d::geometry::ContactForceEvent) {
        profiling::function_scope!();
...
impl RapierConversion<rapier3d::math::Vector> for Vec3 {
    #[inline]
    fn to_rapier(self) -> rapier3d::math::Vector {
        rapier3d::math::Vector::from_array(self.to_array())
    }

    #[inline]
    fn from_rapier(val: rapier3d::math::Vector) -> Self {
